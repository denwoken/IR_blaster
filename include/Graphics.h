...
/**/
    ...
    void printS(int32_t num, uint8_t amount); void printS(int32_t num) { printS(num, 10); } 
    void printU(uint32_t num, uint8_t amount); void printU(uint32_t num) { printU(num, 10); }

    void printR(int32_t num, uint8_t amount); void printR(int32_t num) { printR(num, 10); }
    

    void print(float num, uint8_t integer, uint8_t fractional); void print(float num) { print(num, 3, 3); }
    
    void printFix(int32_t num, uint8_t amount);
    

    void printHex(uint32_t num, uint8_t amount); void printHex(uint32_t num) { printHex(num, 8); }
    void printBin(uint32_t num, uint8_t amount); void printBin(uint32_t num) { printBin(num, 8); }
